define("app/battle/role-debug", [ "../utils/utils-debug", "./viewData-debug", "../config/consts-debug" ], function(require, exports, module) {
    ...
    var roleSex = require("../config/consts-debug").roleSex;
